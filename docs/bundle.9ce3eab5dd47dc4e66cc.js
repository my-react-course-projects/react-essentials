...
var genRandomInt = function genRandomInt(max) {
...
var CORE_CONCEPTS = [{
  image: components_namespaceObject,
  title: 'Components',
  description: 'The core UI building block - compose the user interface by combining multiple components.'
}, {
  image: jsx_ui_namespaceObject,
  title: 'JSX',
  description: 'Return (potentially dynamic) HTML(ish) code to define the actual markup that will be rendered.'
}, {
  image: config_namespaceObject,
  title: 'Props',
  description: 'Make components configurable (and therefore reusable) by passing input data to them.'
}, {
  image: state_mgmt_namespaceObject,
  title: 'State',
...
var Examples = function Examples() {
  ...
  var handleSelect = function handleSelect(selectedButton) {
